...
//   duration: 1,
//   background:
//     "radial-gradient(circle at 30% 30%, rgba(217,70,239,0.25), transparent 50%), radial-gradient(circle at 70% 70%, rgba(20,184,166,0.22), transparent 60%)",
//   backdropFilter: "blur(60px)",
//   boxShadow:
//     "0 0 40px rgba(217,70,239,0.15), 0 0 40px rgba(20,184,166,0.15)",
//   ease: "power2.out",
// });
  ...
  const togglePopup = (e) => {
    if (
      e &&
      (e.target.closest(".carousel-arrow") || e.target.closest(".project__img"))
    ) {
      e.stopPropagation();
      return;
    }
